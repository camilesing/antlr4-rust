...
> Since this [project(antlr4rust)](https://github.com/rrevenantt/antlr4rust) is no longer maintained, I re-established this project based on it to maintain it.
...
Generator part is currently located in rust-target branch of my antlr4 fork [camilesing/antlr4/tree/rust-target](https://github.com/camilesing/antlr4/tree/rust-target)
...
Since version `0.4` works on stable rust.
Previous versions are not maintained anymore 
...
(from default XML grammar but with custom minimal Token/TokenFactory/InputStream/RuleContext) to handwritten implementations in rust ecosystem.
