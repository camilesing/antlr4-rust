...
antlr4_rust::coerce_from! { 'input : SimpleLRParserContext<'input> }
...
antlr4_rust::tid! { impl<'input> TidAble<'input> for dyn SimpleLRParserContext<'input> + 'input }

antlr4_rust::tid! { impl<'input> TidAble<'input> for dyn SimpleLRListener<'input> + 'input }

pub struct SimpleLRParserContextType;
antlr4_rust::tid! {SimpleLRParserContextType}
...
antlr4_rust::tid! { SimpleLRParserExt<'a> }
