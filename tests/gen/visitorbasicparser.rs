...
antlr4_rust::coerce_from! { 'input : VisitorBasicParserContext<'input> }
...
antlr4_rust::tid! { impl<'input> TidAble<'input> for dyn VisitorBasicParserContext<'input> + 'input }

antlr4_rust::tid! { impl<'input> TidAble<'input> for dyn VisitorBasicListener<'input> + 'input }

pub struct VisitorBasicParserContextType;
antlr4_rust::tid! {VisitorBasicParserContextType}
...
antlr4_rust::tid! { VisitorBasicParserExt<'a> }
